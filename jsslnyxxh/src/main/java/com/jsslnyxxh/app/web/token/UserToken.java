 ...
 * under the License.
 */
package com.jsslnyxxh.app.web.token;
...
public class UserToken implements HostAuthenticationToken, RememberMeAuthenticationToken {
     ...
     * @since 1.0
     */
    public UserToken(final String username, final char[] password,final String logintype,
    ...
    public UserToken(final String username, final String password, final String logintype,
                                 final boolean rememberMe, final String host) {
        this(username, password != null ? password.toCharArray() : null,logintype, rememberMe, host);
    }
