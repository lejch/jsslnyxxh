...
String aricleno = "";
String enterloca = "";
if(StringUtils.isNotBlank((String)request.getSession().getAttribute("aricleno"))){
	aricleno = (String)request.getSession().getAttribute("aricleno");
}
if(StringUtils.isNotBlank((String)request.getSession().getAttribute("enterloca"))){
	enterloca = (String)request.getSession().getAttribute("enterloca");
}
%>
<html style="">
  <head>     
	...
	<script src="${ctx}/views/p/mystaic.min.js"></script>
	<script>
	var appPath="${ctx}";
	var errorMsg = '';
	var aricleno = '<%=aricleno%>';
	var enterloca = '<%=enterloca%>';
	errorMsg = '<%=errorMsg%>';
	var isLogin =<%=isLogin%>;
