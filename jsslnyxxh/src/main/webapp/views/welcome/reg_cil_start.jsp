...
<body>
<div style="width:500px;text-align:center;overflow:hidden;height:600px;background:linear-gradient(-360deg, #b1dcf5 23%, #8b9fe5 111%);">
	<div style="position:relative;width:500px;height:300px;">
		<div style="display:inline-block;width:120px;height:120px;border-radius:50%;border:2px solid #fff;margin-top:50px;">
			...
			<div style="color:#fff;font-size:16px;">允许申请理事</div>
		</div>
	...
	<div style="height:300px;background:#fff;padding-top:80px;">
  		<h1><strong style="font-size:15px;font-weight:bold !important;">恭喜，您已可以申请理事！</strong></h1>
  	</div>
</div>
</body>
</html>