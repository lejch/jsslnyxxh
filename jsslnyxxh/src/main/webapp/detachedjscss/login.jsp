...
<html style="">
  <head>     
	...
	<script src="${ctx}/static/zlightMenu/js/jquery.zlight.menu.1.0.min.js"></script>
	<link rel="stylesheet" href="${ctx}/static/zlightMenu/css/zlight.menu.css" media="screen">
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/easyui/themes/metro/easyui.min.css">
	...
	<script type="text/javascript" src="${ctx}/static/hpsearch/js/modernizr.js"></script>
	...
	<link rel="stylesheet" href="${ctx}/static/hpsearch/css/style.css" />
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/sweetAlert/sweetalert.min.css" />
    ...
    <script type="text/javascript" src="${ctx}/static/mystatic/mystatic.min.js"></script>
	<script src="${ctx}/views/welcome/login.js"></script>
	<script>
	var appPath="${ctx}";
...
<body class="content" style="overflow:hidden;background:#eff3f6;">
<div class="content">
	...
	<div id="shyepgmn" style="background:#eff3f6;color:rgb(47,47,47);width:1100px;margin: 0px auto;"></div>
	...
	<div style="background:#f1f1f1;">
		<div class="mainHpPgFooter">
			...
			<div style="text-align:left;width:900px;margin-left:auto;margin-right:auto;margin-top:5px;margin-bottom:20px;font-size:12px;cursor:default;">苏ICP备18055201号</div>
		</div>
	</div>
